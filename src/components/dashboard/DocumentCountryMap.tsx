      ...
      <div className="space-y-4 pt-2">
        ...
        <div className="grid gap-3">
          {topCountries.map((item, index) => {
            ...
            let barColor = "hsl(142, 70%, 50%)"; // Green
            if (ratio > 0.75) barColor = "hsl(0, 75%, 55%)"; // Red
            else if (ratio > 0.5) barColor = "hsl(30, 85%, 55%)"; // Orange
            else if (ratio > 0.25) barColor = "hsl(43, 90%, 60%)"; // Yellow
